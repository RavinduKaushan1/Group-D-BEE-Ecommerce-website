...
$category = 'Men';
$res = $conn->query("SELECT * FROM products WHERE category='Men'");
?>

<!-- Cover Section -->
<section class="cover-section text-light d-flex align-items-center" style="background: url('images/Hero page (carosal img 1).jpg') no-repeat center center/cover; min-height: 80vh; position: relative;">
  <div class="container position-relative z-2">
    <h1 class="display-3 fw-bold mb-3 text-warning" style="text-shadow: 0 2px 16px rgba(0,0,0,0.18);">Bee Men</h1>
    <p class="lead fs-4" style="text-shadow: 0 2px 8px rgba(0,0,0,0.12);">Performance and style built for every move.</p>
  </div>
